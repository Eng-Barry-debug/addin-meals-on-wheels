...
// Install Distinct Newsletter Templates
require_once __DIR__ . '/includes/config.php';

echo "🍽️  Addins Meals on Wheels - DISTINCT Templates Installation\n";
echo "=============================================================\n\n";
...
try {
    ...
    echo "📧 Installing DISTINCT professional templates...\n\n";

    // Template 1: Bold Promotional
    echo "   🔥 Bold Promotional Template\n";
    $stmt = $pdo->prepare('INSERT INTO newsletter_templates (name, description, html_template, is_active) VALUES (?, ?, ?, 1)');
    $stmt->execute([
        'Bold Promotional',
        'Energetic template with bright colors perfect for flash sales, special offers, and promotional campaigns',
        '<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    // Template 2: Minimalist News
    echo "   📄 Minimalist News Template\n";
    $stmt->execute([
        'Minimalist News',
        'Ultra-clean template with minimal design perfect for company news, updates, and professional announcements',
        '<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    // Template 3: Premium Event
    echo "   👑 Premium Event Template\n";
    $stmt->execute([
        'Premium Event',
        'Luxurious invitation-style template with gold accents perfect for VIP events, celebrations, and exclusive gatherings',
        '<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="event-container">
        ...
        <div class="premium-footer">
            ...
            <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255,215,0,0.2); font-size: 12px; color: rgba(255,255,255,0.6);">
                <p><a href="{{UNSUBSCRIBE_URL}}" style="color: #FFD700;">Unsubscribe</a> | <a href="{{WEBSITE_URL}}" style="color: #FFD700;">Visit Website</a></p>
                <p style="margin-top: 8px;">&copy; {{YEAR}} Addins Meals on Wheels. All rights reserved.</p>
            </div>
        </div>
    </div>
    ...
    echo "\n✅ DISTINCT templates installed successfully!\n";
    echo "🎨 Each template now has a unique visual identity:\n";
    echo "   🔥 Bold Promotional - Orange/blue energetic theme\n";
    echo "   📄 Minimalist News - Clean black/white professional\n";
    echo "   👑 Premium Event - Luxury gold/black sophisticated\n";
    echo "\n✨ Templates are ready in your newsletter creation modal!\n";
